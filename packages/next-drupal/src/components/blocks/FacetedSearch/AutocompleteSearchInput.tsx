import { AutoCompleteItem } from '@edw/next-drupal/@types'
...
import SearchIcon from '@edw/next-drupal/assets/icons/search.svg'
import { useAutoComplete } from '@edw/next-drupal/hooks/useAutoComplete'
